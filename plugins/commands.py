...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('💠 GᏒԾUᎮ 💠', url='https://t.me/moviespot00100')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('💠 G💠', url='https://t.me/moviespot001100'),
            InlineKeyboardButton('💠 CHΛΞL 💠', url='https://t.me/moviespot00100')
            ],[
    ...
    if len(message.command) ==2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('💠 GᏒᎮ 💠', url='https://t.me/+EqhXLhL3T1w4Zjc1'),
            InlineKeyboardButton('💠 CHΛИL 💠', url='https://t.me/+veUIdIW2CQ5mOGU5')
            ],[
            InlineKeyboardButton('💰 ᎮΛIᎠ ᎮᏒᎧᎷᎧϮIᎧИ 💰', callback_data='donation')
            ],[
            InlineKeyboardButton('♻️ HΞLᎮ ♻️', callback_data='help'),
